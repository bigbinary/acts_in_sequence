...
class ActsInSequenceTest < Minitest::Test
  def test_that_it_has_a_version_number
    refute_nil ::ActsInSequence::VERSION
  end

  def test_that_we_could_check_whether_a_model_is_sequenceable?
    refute Parent.acts_in_sequence?
    assert Child.acts_in_sequence?
    assert Independent.acts_in_sequence?
  end
